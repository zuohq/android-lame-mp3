...
/***
 * {@link "https://github.com/naman14/TAndroidLame/blob/master/androidlame/src/main/java/com/naman14/androidlame/AndroidLame.java"}
 */
public class Mp3Encoder {
    ...
    public Mp3Encoder(LameBuilder builder) {
        initialize(builder);
    }
