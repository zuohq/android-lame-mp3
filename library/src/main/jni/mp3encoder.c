...
JNIEXPORT void JNICALL Java_com_martin_library_Mp3Encoder_initializeDefault(
        JNIEnv *env, jclass cls) {

glf = initializeDefault(env);
}

JNIEXPORT void JNICALL Java_com_martin_library_Mp3Encoder_initialize(
...
JNIEXPORT jint JNICALL Java_com_martin_library_Mp3Encoder_lameEncode(
...
JNIEXPORT jint JNICALL Java_com_martin_library_Mp3Encoder_encodeBufferInterleaved(
        JNIEnv *env, jclass cls, jshortArray pcm,
        jint samples, jbyteArray mp3buf) {
    return encodeBufferInterleaved(env, glf, pcm, samples, mp3buf);
}

JNIEXPORT jint JNICALL Java_com_martin_library_Mp3Encoder_lameFlush(
        JNIEnv *env, jclass cls, jbyteArray mp3buf) {
    return flush(env, glf, mp3buf);
}

JNIEXPORT void JNICALL Java_com_martin_library_Mp3Encoder_lameClose(
        JNIEnv *env, jclass cls) {
close(glf);
}
